...
describe("Text", () => {
  const makeTestCases = (text: string, expected: string[]) => {
    ...
    const patternsStringList = patternsList
  ...
  it("あんこ", () => {
    const [patternsStringList, expected] = makeTestCases("あんこ", [
      "anko",
      "annko",
      "axnko",
      "anco",
  ...
  it("アンコール", () => {
    const [patternsStringList, expected] = makeTestCases("アンコール", [
      "anko-ru",
      "annko-ru",
      "axnko-ru",
      "anco-ru",
  ...
  it("ちゃんと", () => {
    const [patternsStringList, expected] = makeTestCases("ちゃんと", [
      "chanto",
      "channto",
      "chaxnto",
      "tyanto",
  ...
  it("だっっさ", () => {
    const [patternsStringList, expected] = makeTestCases("だっっさ", [
      "dasssa",
    ]);
    expect(patternsStringList).toEqual(expected);
  });
  ...
  it("らっきょ", () => {
    const [patternsStringList, expected] = makeTestCases("らっきょ", [
      "rakkyo",
      "rakkilyo",
      "rakkixyo",
    ]);
  ...
  it("あびゃびゃ", () => {
    const [patternsStringList, expected] = makeTestCases("あびゃびゃ", [
      "abyabya",
      "abyabilya",
      "abyabixya",
